...
data4   = data2_analytic(startPos + 3  * stepWidth + 1 : startPos + 4  * stepWidth); % 98411, 68(is adsb) NO1;
...
adsbSeq = data4(98411 + 1 : 98411 + 2640);
figure;
hold on;
...
% preamble = adsbSeq(1 : 22 * 8);
% preambleStd = mean4FrontPulse * preambleTemp;
% R    = conv(preambleTemp, data4);
% % Rstd = conv(preambleTemp, preambleStd);
% figure;
% plot(R);
% hold on;
% title('卷积');
